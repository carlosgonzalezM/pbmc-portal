            ...
            <div className="w-full flex justify-between p-5 m-5 px-11">
                <div className="flex justify-center items-center flex-col ">
                    <h1 className=" text-2xl text-start font-bold text-[#FFFFFF] mb-6 pb-2">
                        <span className=' pb-2 border-b-2  border-b-magentapb'>Tecn</span>ologia 
                    </h1>

                    <img src="../../../images/Logo-Perfect-body-blanco.png" alt="perfect"  className='w-[240px] h-auto'/>
                
                    <img src="../../../images/Supersalud-1-300x120.png" alt="perfect"  className='w-[240px] h-auto'/>

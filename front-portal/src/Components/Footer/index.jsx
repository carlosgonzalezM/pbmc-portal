            ...
            <div className="w-full flex justify-between items-center pt-12">
                <div className="w-full flex justify-between p-5 m-5 px-11">
                    <div className="flex justify-center items-center flex-col ">
                        <h1 className=" text-2xl text-start font-bold font-serif text-[#FFFFFF] mb-6 pb-2">
                    ...
                    <div className="flex flex-col justify-start items-start">
                        <h1 className=" text-2xl text-start font-bold text-[#FFFFFF] mb-6 pb-2 font-serif">
                            <span className=' pb-2 border-b-2  border-b-magentapb'>Nuest</span>ros Servicios 
                        </h1>
                        <div className="flex flex-col justify-start items-start">
                            <p className="  text-sm mb-4 text-[#FFFFFF] font-medium font-serif">
